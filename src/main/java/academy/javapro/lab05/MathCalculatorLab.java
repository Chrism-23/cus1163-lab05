...
public class MathCalculatorLab {
    ...
    public static Runnable fibonacciCalculator(CalculatorBase calc) {
        Runnable task = () -> {
            ...
            int n = calc.n;
            long result = 0;
            System.out.println(str + " computing: fib(" + n + ")");
            if(n <= 1)
            {
                result = n;
            }
            ...
            calc.result = result;
            System.out.println(str + " completed: fibonacci(" + n + ") = " + result);
        };
        return task;
    }
    ...
    public static Runnable sumOfSquaresCalculator(CalculatorBase calc) {
        Runnable task = () -> {
            ...
            int n = calc.n;
            long sum = 0;
            System.out.println(str + " 1² + 2² + 3² + ... + " + n + "²");
            for (int i = 1; i <= n; i++)
            {
                sum += i * i;
                try
            ...
            calc.result = sum;
            System.out.println(str + " completed: sumOfSquares(" + n + ") = " + sum);
        };
        return task;
    }
